    ...
    <footer>
            ...
            <div className="columns  is-mobile">
              <div className="column">
                <div className="has-text-left">
                  <p>
                    &nbsp; <img src={ImageG} alt="GatsbyJs" /> Gatsby JS
                  </p>
                  <br />
              ...
              <div className="column">
                <div className="has-text-left">
                  <p>
                    <img src={ImageWP} alt="WordPress" /> WordPress
                  </p>
                  <br />
                  <p>
                    <img src={ImageSS} alt="SquareSpace" /> SquareSpace
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="has-text-left">
              <ul>
                ...
                <li>
                  <a
                    className="alist is-size-5"
                    href="/ongoing-success"
                    aria-label="Go to success plan"
                  >
                    Ongoing Success
                  </a>
                </li>
                ...
                <li>
                  <a
                    ...
                    aria-label="Go to static websites"
                  >
                    Static Websites
                  </a>
                </li>
                <li>
                  <a
                    ...
                    aria-label="Go to wordpress websites"
                  >
                    WordPress Websites
                  </a>
                </li>
            ...
            >
              ...
              <div className="field">
                <div className="control has-text-centered">
                  <button
                    type="submit"
                    className="btn button is-info is-centered is-size-6"
                  >
                    Send
                  </button>
                </div>
      ...
      <div className="container">
        ...
        <ul className="footer-nav list-inline">
          ...
          <li className="list-inline-item">
            <Link to="/privacy" aria-label="Go to privacy page">
              Privacy
            </Link>
          </li>
          <li className="list-inline-item">
            <Link to="/blog" aria-label="Go to blog page">
              Blog
            </Link>
          </li>
        </ul>
        ...
        <div>
          ...
          <Scroll type="id" element="top">
            <a
              className="btn button is-info is-small"
              href="#top"
              title="Scroll to top"
