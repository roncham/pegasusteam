            ...
            <section className="privacy">
              <div className="content">
                <div className="container">
                  ...
                  <p>The following describes the Privacy Policy for the PegasusTeam.com website.</p>
                  <p><strong>Your Privacy</strong><br />
                  Your privacy is important to us at PegasusTeam.  To better protect your privacy we provide this notice explaining our online information practices and the choices you can make about the way your information is collected and used.  You agree to agree to these policies by virtue of using our website in a way that leads to you providing us with personal information.</p>
                  <p><strong>State Law &#038; Accompanying Rights</strong><br />
                  ...
                  <p>While we are staunch privacy advocates at PegasusTeam, there are times when even we may be forced to abandon these ideals.  Just as major search engines face ongoing compulsion to provide data against their will, so too may the same occur with our PegasusTeam.com website.  Illegal activity or other serious acts or allegations could create legal liability for our website.  In those cases, we reserve the right to share your information, or else may simply be compelled to do so by law.  On the other hand, there may be times when we would need to share your private information in order to protect our own interests.  For instance, in cases of suspected or alleged copyright infringement or other intellectual property violations, it may be necessary to share personal information.</p>
                  <p><strong>Google Adsense and the DoubleClick DART Cookie</strong><br />
                  Google, as a third party advertisement vendor, may use cookies to serve ads on this PegasusTeam.com website.  The use of DART cookies by Google enables them to serve adverts to visitors that are based on their visits to this website, including past visits, as well as other websites on the internet.</p>
                  ...
                  <p><strong>COPYRIGHT WARNING:</strong> The legal notices and administrative pages on this website, including this one, have been diligently drafted by an attorney.  We at PegasusTeam have paid to license the use of these legal notices and administrative pages on PegasusTeam.com for your protection and ours.  This material may not be used in any way for any reason and unauthorized use is policed via Copyscape to detect violators.</p>
                  ...
                  <p><a href="/contact" aria-label="Go to contact form">http://www.pegasusteam.com/contact</a></p>  
                  <p>Effective as of January 1, 2020</p>
                </div>
              </div>
            </section>
          </div>
